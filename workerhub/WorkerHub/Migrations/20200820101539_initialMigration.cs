        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InactiveUsers = table.Column<bool>(type: "bit", nullable: true),
                    Descripition = table.Column<string>(type: "nvarchar(255)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Experices", x => x.Id);
                    table.ForeignKey(
