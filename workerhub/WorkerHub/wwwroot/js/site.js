...
if (document.getElementById("myprofile")) {
    ...
    var two = document.getElementById("delete1");
    var three = document.getElementById("logoutt1");
...
function color2() {
    var one = document.getElementById("ViewProfile");
    var two = document.getElementById("Delete");
    var three = document.getElementById("logout");
